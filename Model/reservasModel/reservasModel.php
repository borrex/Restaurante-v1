...
require_once 'Model/conexion.php';
 ...
 class Datos{
       ...
       #obtener todas reservas
 	 	static public function getReservasModel( $tabla){
 	 ...
 	 // agregar Reservas
 	 static public function agregarReservasModel($datosModel,$tabla){
 	 	...
 	 	static public  function deleteReservaModel($datosModel,$tabla){
     ...
     static public  function totalReservasModel($tabla){
     ...
     static public  function editarReservasModel($datosModel,$tabla){
        date_default_timezone_set('America/Argentina/Buenos_Aires');
